    ...
    <div class="col-12">        
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{route('admin')}}">
                {{-- <img src="{{asset('assets/images/logo.jpeg')}}" width="30" alt="Coupon Percent Off"> --}}
                <span class="m-l-10">couponspercentoff</span>
            </a>
        </div>
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="{{route("admin.logout")}}" class="mega-menu" data-close="true"><i class="zmdi zmdi-power"></i></a></li>
